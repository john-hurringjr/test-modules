...
resource "google_project_service" "enable_iap_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_dlp_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_sql_component_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_sql_admin_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_datacatalog_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_healthcare_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_dataproc_metastore_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_service_directory_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
...
resource "google_project_service" "enable_scheduler_api" {
  depends_on          = [google_project.project, google_project_service.enable_compute_api]
  project             = google_project.project.project_id
