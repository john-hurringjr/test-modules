...
resource "google_access_context_manager_service_perimeter_resource" "service_perimeter_resource_add" {
  depends_on      = [google_project.project, google_project_service.enable_storage_api, google_project_service.enable_bigquery_api, google_project_service.enable_pubsub_api]
